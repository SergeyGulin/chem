...
const audioPaths: { [key in soundsType]: string } = {
    BEST_RESULTS: process.env.PUBLIC_URL + '/sounds/477552__abacagi__explosion-sfx.mp3',
    ERROR_RESULTS: process.env.PUBLIC_URL + '/sounds/133817__prutsik__space-swoosh.mp3',
